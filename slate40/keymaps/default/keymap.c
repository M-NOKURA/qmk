...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        TD(ESC_LCADEL), KC_Q,         KC_W,             KC_E,             KC_R,          KC_T,         KC_Y,          KC_U,             KC_I,            KC_O,            KC_P,            KC_BSPC,
        ...
        // KC_LCTL,        KC_LALT,      KC_LGUI,          KC_ESC,                          LT(3,KC_SPC),                LT(3,KC_RGUI),    KC_SLSH,         KC_LEFT,         KC_DOWN,         KC_RGHT
        KC_LCTL,        KC_LALT,      KC_LGUI,          KC_LGUI,                         LT(3,KC_SPC),                LT(3,KC_RGUI),    LT(3,KC_SLSH),   KC_LEFT,         KC_DOWN,         KC_RGHT
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ),
    [_WIN] = LAYOUT(
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        KC_TRNS,        KC_TRNS,      KC_TRNS,          KC_TRNS,          KC_TRNS,       KC_TRNS,      KC_TRNS,       KC_TRNS,          KC_TRNS,         KC_TRNS,         KC_TRNS,         KC_TRNS,
        KC_TRNS,        KC_TRNS,      KC_TRNS,          KC_TRNS,          KC_TRNS,       KC_TRNS,      KC_TRNS,       KC_TRNS,          KC_TRNS,         KC_TRNS,         KC_TRNS,         KC_TRNS,
        KC_TRNS,        KC_LGUI,      LALT_T(JP_MHEN),  LALT_T(JP_MHEN),                 KC_TRNS,                     LT(3,JP_HENK),    KC_TRNS,         KC_TRNS,         KC_TRNS,         KC_TRNS
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ),
    [_FUNC] = LAYOUT(
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        KC_TRNS,        KC_TRNS,      KC_TRNS,          KC_TRNS,          KC_TRNS,       KC_F19,       KC_RBRC,       KC_NUHS,          LSFT(KC_RBRC),   LSFT(KC_NUHS),   LCTL(KC_HOME),   KC_INT1,
        KC_TRNS,        KC_TRNS,      KC_TRNS,          KC_TRNS,                         KC_TRNS,                     KC_TRNS,          KC_LBRC,         LCTL(KC_PGUP),   LCTL(KC_END),    LCTL(KC_PGDN)
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ),
    [_NUM] = LAYOUT(
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        LCA(KC_DEL),    LSFT(KC_1),   LSFT(KC_2),       LSFT(KC_3),       LSFT(KC_4),    LSFT(KC_5),   LSFT(KC_6),     LSFT(KC_7),      LSFT(KC_8),     LSFT(KC_9),      LSFT(KC_0),     KC_INT3,
        KC_DOT,         KC_1,         KC_2,             KC_3,             KC_4,          KC_5,         KC_6,           KC_7,            KC_8,           KC_9,            KC_0,           KC_QUOT,
        KC_TRNS,        DF(0),        DF(1),            XXXXXXX,          XXXXXXX,       KC_TRNS,      LSFT(KC_MINS),  LSFT(KC_SCLN),   KC_MINUS,       LSFT(KC_QUOT),   KC_VOLU,        RGB_TOG,
        QK_BOOT,        KC_LCTL,      KC_LALT,          KC_LGUI,                         KC_TRNS,                      KC_TRNS,         KC_TRNS,        KC_TRNS,         KC_VOLD,        KC_TRNS
      //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    )
};
