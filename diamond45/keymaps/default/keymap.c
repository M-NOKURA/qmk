...
int16_t mouse_record_threshold = 30;    // default:30 ポインターの動きを一時的に記録するフレーム数。 Number of frames in which the pointer movement is temporarily recorded.
int16_t mouse_move_count_ratio = 3;     // default:5 ポインターの動きを再生する際の移動フレームの係数。 The coefficient of the moving frame when replaying the pointer movement.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
      //--------------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------//
        ...
        LT(2,KC_ENT),   LT(2,KC_A), KC_S,           KC_D,           KC_F,       KC_G,                       KC_DEL,     LT(2,KC_H),     KC_J,           KC_K,               KC_L,           KC_MINUS,               KC_ENT,
        KC_LSFT,        KC_Z,       KC_X,           KC_C,           KC_V,       KC_B,                                   KC_N,           KC_M,           KC_COMM,            KC_DOT,         KC_SLSH,        KC_UP,          RSFT_T(KC_INT1),
        // KC_LCTL,        KC_LALT,                 KC_LGUI,         KC_ESC,       LT(3,KC_SPC),   KC_BTN1,    KC_BTN2,                    LT(3,KC_SPC),   LT(3,KC_RGUI),      TD(TD_CAD),     KC_LEFT,        KC_DOWN,        KC_RGHT
        KC_LCTL,        KC_LALT,                 KC_LGUI,         KC_ESC,       LT(3,KC_SPC),   KC_BTN1,    KC_BTN2,                    LT(3,KC_SPC),   LT(3,KC_RGUI),      LT(3,KC_LBRC),     KC_LEFT,        KC_DOWN,        KC_RGHT
      //--------------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------//
    ),
    [_WIN] = LAYOUT(
      //--------------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------//
        KC_TRNS,        KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,    KC_TRNS,                                KC_TRNS,        KC_TRNS,        KC_TRNS,            KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        LT(2,KC_F2),    KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,    KC_TRNS,                    KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,            KC_TRNS,        KC_TRNS,                KC_TRNS,
        KC_TRNS,        KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,    KC_TRNS,                                KC_TRNS,        KC_TRNS,        KC_TRNS,            KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
    ...
    [_FUNC] = LAYOUT(
      //--------------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------//
        ...
        KC_TRNS,        KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,    KC_F19,                                 KC_RBRC,        KC_NUHS,        LSFT(KC_RBRC),      LSFT(KC_NUHS),  LSFT(KC_SLSH),  LCTL(KC_HOME),  KC_INT1,
        KC_TRNS,        KC_TRNS,                 KC_TRNS,         KC_TRNS,      KC_PGDN,        KC_WH_D,    KC_WH_U,                    KC_PGUP,        KC_TRNS,            KC_TRNS,        LCTL(KC_PGUP),  LCTL(KC_END),   LCTL(KC_PGDN)
      //--------------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------//
    ),
    [_NUM] = LAYOUT(
      //--------------------------------------------------------------------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------//
        ...
        KC_DOT,         KC_1,       KC_2,           KC_3,           KC_4,       KC_5,                       KC_TRNS,    KC_6,           KC_7,           KC_8,               KC_9,           KC_0,                   KC_TRNS,
        KC_TRNS,        DF(0),      DF(1),          XXXXXXX,        XXXXXXX,    KC_TRNS,                                LSFT(KC_MINS),  LSFT(KC_SCLN),  KC_MINUS,           LSFT(KC_QUOT),  KC_SLSH,        KC_VOLU,        XXXXXXX,
...
report_mouse_t pointing_device_task_user(report_mouse_t mouse_report) {
    // debug
    if(my_abs(mouse_report.x) / my_abs(mouse_report.y) > 5) mouse_report.y = 0;
    if(my_abs(mouse_report.y) / my_abs(mouse_report.x) > 5) mouse_report.x = 0;
...
void oled_write_type_count(void) {
    ...
    if(type_count < 9999) {
        ...
        itoa(type_count / 1000, type_count_str, 10);
