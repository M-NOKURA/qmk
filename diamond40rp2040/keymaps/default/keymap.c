...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        LT(2,KC_F2),   LT(2,KC_A),  KC_S,       KC_D,            KC_F,         KC_G,                KC_H,           KC_J,             KC_K,           KC_L,           KC_MINUS,       KC_ENT,
        KC_LSFT,       KC_Z,        KC_X,       KC_C,            KC_V,         KC_B,                KC_N,           KC_M,             KC_COMM,        KC_DOT,         KC_UP,          RSFT_T(KC_INT1),
        KC_LCTL,       KC_LALT,     KC_LALT,    KC_LGUI,         KC_ESC,       LT(3,KC_SPC),        LT(3,KC_SPC),   LT(3,KC_RGUI),    KC_SLSH,        KC_LEFT,        KC_DOWN,        KC_RGHT
    ),
    [_WIN] = LAYOUT(
        KC_TRNS,       KC_TRNS,     KC_TRNS,    KC_TRNS,         KC_TRNS,      KC_TRNS,             KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_TRNS,     KC_TRNS,    KC_TRNS,         KC_TRNS,      KC_TRNS,             KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_TRNS,     KC_TRNS,    KC_TRNS,         KC_TRNS,      KC_TRNS,             KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_LGUI,     KC_LGUI,    LALT_T(JP_MHEN), KC_TRNS,      KC_TRNS,             KC_TRNS,        RALT_T(JP_HENK),  KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS
    ),
    [_FUNC] = LAYOUT(
