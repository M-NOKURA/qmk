...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN] = LAYOUT(
        ...
        KC_TRNS,       KC_TRNS,     KC_TRNS,    KC_TRNS,      KC_TRNS,        KC_TRNS,                                KC_TRNS,        KC_TRNS,          KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        KC_TRNS,       KC_LGUI,     KC_LALT,    KC_LALT,      LALT_T(JP_MHEN),KC_TRNS,     LCTL(KC_L), LCA(KC_DEL),   KC_TRNS,        RALT_T(JP_HENK),  KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS
    ),
    [_FUNC] = LAYOUT(
    ...
    [_NUM] = LAYOUT(
        ...
        QK_BOOT,       XXXXXXX,     XXXXXXX,    XXXXXXX,      XXXXXXX,        KC_PGDN,         KC_F17, KC_F18,        KC_PGUP,        XXXXXXX,          XXXXXXX,        XXXXXXX,        KC_VOLD,        XXXXXXX
    )
};
